...
public class JwtTokenProvider {
    ...
    public String refreshToken(String token) {
    	Claims UserPk = Jwts.parser().setSigningKey(secretKey).parseClaimsJws(token).getBody();
    	return this.createToken(String.valueOf(UserPk.get("sub")), (List<String>) UserPk.get("roles"));
    }
